...
CMyShellManager* g_pShellManager = NULL;

UINT MYPM_ON_AFTER_SHELL_COMMAND	= ::RegisterWindowMessage (_T("MYPM_ON_AFTER_SHELL_COMMAND"));
...
//****************************************************************************************
int CALLBACK CMyShellManager::BrowseCallbackProc (
	HWND hwnd, UINT uMsg, LPARAM /*lParam*/, LPARAM lpData)
{
	if (uMsg == BFFM_INITIALIZED)
	{
		CMyShellManager* pThis = (CMyShellManager*) lpData;
		ASSERT_VALID (pThis);
...
//****************************************************************************************
BOOL CMyShellManager::BrowseForFolder (CString& strFolder,
...
//***************************************************************************************
LPITEMIDLIST CMyShellManager::GetNextItem (LPCITEMIDLIST pidl)
{
	if (pidl == NULL)
	{
		return NULL;
...
//***************************************************************************************
LPITEMIDLIST CMyShellManager::CreateItem (UINT cbSize)
{
...
//***************************************************************************************
UINT CMyShellManager::GetItemCount (LPCITEMIDLIST pidl)
{
	if (pidl == NULL)
	{
		return 0;
...
//***************************************************************************************
UINT CMyShellManager::GetItemSize (LPCITEMIDLIST pidl)
{
	UINT           cbTotal = 0;
...
//****************************************************************************************
LPITEMIDLIST CMyShellManager::ConcatenateItem (LPCITEMIDLIST pidl1, LPCITEMIDLIST pidl2)
{
	UINT cb1 = 0;
...
//****************************************************************************************
LPITEMIDLIST CMyShellManager::CopyItem (LPCITEMIDLIST pidlSource)
{
	ASSERT (m_pBCGMalloc != NULL);
...
//****************************************************************************************
void CMyShellManager::FreeItem (LPITEMIDLIST pidl)
{
	ASSERT (m_pBCGMalloc != NULL);
...
//***************************************************************************************
HRESULT CMyShellManager::ItemFromPath (LPCTSTR lpszPath, LPITEMIDLIST& pidl)
{
...
//***************************************************************************************
int CMyShellManager::GetParentItem (LPCITEMIDLIST lpidl, LPITEMIDLIST& lpidlParent)
{
