...
import com.bao.lc.proxy.IEProxy.WinInet.INTERNET_PER_CONN_OPTION;
import com.bao.lc.proxy.IEProxy.WinInet.INTERNET_PER_CONN_OPTION_LIST;
...
/**
 * Picked up from OWASP
 * Original name: org.owasp.proxy.util.WindowsProxy
 */
